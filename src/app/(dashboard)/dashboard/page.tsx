  ...
  return (
    <div className="min-h-screen bg-[#FAF8F5] text-[#1A1A1A] selection:bg-[#C5A059] selection:text-white flex flex-col select-none">
      ...
      <main className="flex-1 py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto space-y-8 w-full">
          ...
          <div className="card-luxury p-6 border border-[#C5A059]/30 flex flex-col justify-between space-y-4 shadow-sm">
            <div className="flex items-center justify-between">
              <h3 className="text-sm font-bold text-slate-700 uppercase tracking-wider flex items-center gap-1.5">
                <PieChart className="w-4 h-4 text-emerald-600" /> Asistencia Global
              </h3>
              <span className="text-xs font-extrabold text-emerald-800 bg-emerald-50 px-2.5 py-1 rounded-full border border-emerald-200 shadow-xs">
                {metrics.occupancyPercentage}% Ingresado
              </span>
            </div>

            <div className="flex items-center justify-center gap-6 py-2">
              {/* Radial Donut SVG with Soft Mint Emerald Pastel Accent */}
              ...
              <div className="space-y-2 text-xs">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-slate-600 font-medium">Ingresados:</span>
                  <strong className="font-bold text-slate-900">{metrics.totalEntered}</strong>
                </div>
                <div className="flex items-center gap-2">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-3 gap-3">
              <div className="card-luxury p-4 border-l-4 border-emerald-500 text-center shadow-xs">
              ...
              <div className="card-luxury p-4 border-l-4 border-amber-500 text-center shadow-xs">
              ...
              <div className="card-luxury p-4 border-l-4 border-slate-400 text-center shadow-xs">
            ...
            <div className="card-luxury p-5 space-y-3 shadow-sm">
          ...
          <div className="card-luxury p-6 border border-[#C5A059]/30 lg:col-span-2 space-y-4 shadow-sm">
                    ...
                    <div className="w-full bg-slate-200 h-2 rounded-full overflow-hidden">
                      <div 
                        className={`h-full transition-all duration-500 ${
                          table.occupancyPercentage >= 100 ? 'bg-emerald-500' :
                          table.occupancyPercentage > 0 ? 'bg-indigo-500' : 'bg-slate-300'
                        }`}
        ...
        <div className="card-luxury p-4 text-xs text-slate-600 flex flex-col sm:flex-row items-center justify-between gap-3 border border-[#C5A059]/30 shadow-xs">
